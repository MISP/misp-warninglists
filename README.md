...
- [apple-domains/list.json](./lists/apple-domains/list.json) - **List of known Apple hosts for enterprise networks** - _Hosts that Apple products need to access on enterprise networks, merged from Apple's support article (https://support.apple.com/en-us/101555) and the v2fly domain-list-community 'apple' data set (and its includes)._
...
- [cachefly/list.json](./lists/cachefly/list.json) - **List of known CacheFly IP address ranges** - _CacheFly IP address ranges (https://cachefly.cachefly.net/ips/cdn.txt)_
...
- [cdn77/list.json](./lists/cdn77/list.json) - **List of known CDN77 IP address ranges** - _CDN77 IP address ranges (https://prefixlists.tools.cdn77.com/public_lmax_prefixes.json)_
...
- [digitalocean/list.json](./lists/digitalocean/list.json) - **List of known DigitalOcean IP address ranges** - _DigitalOcean IP address ranges, from their published RFC 8805 geofeed (https://digitalocean.com/geo/google.csv)_
...
- [gcore/list.json](./lists/gcore/list.json) - **List of known Gcore CDN IP address ranges** - _Gcore CDN IP address ranges (https://api.gcore.com/cdn/public-net-list)_
...
- [google/list.json](./lists/google/list.json) - **List of known google domains** - _Event contains one or more entries of known google domains, merged from Google's own supported_domains list, the nickspaargaren/no-google community blocklist, and the v2fly domain-list-community 'google' data set._
...
- [imperva/list.json](./lists/imperva/list.json) - **List of known Imperva (Incapsula) IP address ranges** - _Imperva (Incapsula) IP address ranges (https://my.imperva.com/api/integration/v1/ips)_
...
- [linode/list.json](./lists/linode/list.json) - **List of known Linode (Akamai Connected Cloud) IP address ranges** - _Linode (Akamai Connected Cloud) IP address ranges, from their published RFC 8805 geofeed (https://geoip.linode.com/)_
...
- [majestic_million/list.json](./lists/majestic_million/list.json) - **Top 10000 websites from Majestic Million** - _Event contains one or more entries from the top 10000 of the most used websites (Majestic Million)._
...
- [openai-gptbot/list.json](./lists/openai-gptbot/list.json) - **List of known IP address ranges for OpenAI GPT crawler bot** - _OpenAI gptbot crawler (https://openai.com/gptbot.json)_
...
- [sucuri/list.json](./lists/sucuri/list.json) - **List of known Sucuri (Website Firewall) IP address ranges** - _Sucuri Website Firewall IP address ranges, scraped from https://docs.sucuri.net/website-firewall/sucuri-firewall-troubleshooting-guide/ (no machine-readable API is published)_
...
- [tor-exit-nodes/list.json](./lists/tor-exit-nodes/list.json) - **List of known Tor exit nodes** - _Specialized list of IPv4 addresses belonging to Tor exit nodes, from https://github.com/X4BNet/lists_torexit_
...
- [vpn-ipv6/list.json](./lists/vpn-ipv6/list.json) - **Specialized list of vpn-ipv6 addresses belonging to common VPN providers and datacenters** - _Specialized list of vpn-ipv6 addresses belonging to common VPN providers and datacenters_
